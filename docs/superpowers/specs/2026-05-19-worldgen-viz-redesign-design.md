...
| PR | Title | Scope |
|---|---|---|
| **1** | viz: streaming skeleton | New binary; fly cam; LRU chunk cache; reuse mesher; block paint mode only; dashboard layout with placeholder panels. **Replaces old binary.** |
